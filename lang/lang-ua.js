...
window.translation = {
  titleFull: "Azgaar Генератор Фентезі Карт",
  titleName: "Azgaar",
  title: "Генератор Фентезі Карт",
  version: "v. ",
  ...
  tipRegenerate: "Натисніть, щоб створити нову карту. Гаряча клавіша: F2",
  ...
  layersTab: "Натисніть, щоб змінити слої карти",
  styleTab: "Натисніть, щоб відкрити редактор стилів",
  optionsTab: "Click to change generation and UI options",
  toolsTab: "Натисніть, щоб відкрити меню інструментів",
  aboutTab: "Натисніть, щоб побачити інформацію про Генератор"
};
...
const sourceDataForReference = {
  ...
  NeedToAdd!: "Перегенерувати назву карти",
  ...
  saveButton: "Оберіть формат, щоб зберегти карту",
  ...
  labelTextRandom: "Згенерувати випадкову назву",
  ...
  lakeGroupRemove: "Видалити групу",
  ...
  coastlineGroupRemove: "Видалити групу",
  ...
  markerGroup: "Змінити тип маркеру",
  markerSelectGroup: "Обрати тип для обраного маркеру",
  markerInputGroup: "Створити новий тип для обраного маркеру",
  markerAddGroup: "Створити новий тип маркерів",
  markerRemoveGroup: "Видалити всі маркери цього типу",
  ...
  markerSize: "Змінити розмір маркеру",
  ...
  templateSave: "Завантажити шаблон, як текстовий файл",
  templateLoad: "Відкрити попередньо завантажений шаблон",
  ...
  provincesEditorRefresh: "Перезавантажити Редактор",
  ...
  militaryVisualize: "Показати армії на карті",
